    ...
    <Container>
      ...
      <Modal show={showMetadataModal} onHide={() => setShowMetadataModal(false)} size="lg">
        <Modal.Header closeButton>
          <Modal.Title>⚙️ Configure Agent</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
            <Row>
          ...
          {currentValidationResult && (
            <>
                  ...
                  <Card className="text-center">
                    <Card.Body>
                      <h2 className={`text-${currentValidationResult.deployment_ready ? 'success' : 'warning'}`}>
                        {currentValidationResult.deployment_ready ? '✅' : '⚠️'}
                      </h2>
                      <Card.Text>
              ...
              <Alert variant={currentValidationResult.deployment_ready ? 'success' : 'warning'}>
                <Alert.Heading>
                  {currentValidationResult.deployment_ready ? '🎉 Validation Passed!' : '⚠️ Validation Issues Found'}
                </Alert.Heading>
